...
app.post('/eventos', async function   (req, res) {
    ...
    try {
        ...
        await  axios.post('http://ecm516-20262-observacoes-clusterip-service:5001/eventos', evento)
    }
    catch(e) {}
    try {
        //envia o evento para o microsserviço de consulta
        await axios.post('http://ecm516-20262-consulta-clusterip-service:6000/eventos', evento)
    } catch (e) {}

    try{
        //envia o evento para o microsservico de classificacao
        await axios.post('http://ecm516-20262-classificacao-clusterip-service:7000/eventos', evento)
    } catch (e){}
    res.end()
})
